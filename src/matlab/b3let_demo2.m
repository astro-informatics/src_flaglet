...
%subplot(3,2,1)
%b3let_plot_axisym_wavelet_kernel(kappa_ln, R, Rplot1, P)
%title('Original wavelet')

figure('Position',[100 100 300 1100])

subplot(3,1,1)
b3let_plot_axisym_wavelet_kernel(kappa_ln_translated1, R, Rplot1, P)
%title(['Wavelet translated by ',num2str(s1)])

subplot(3,1,2)
b3let_plot_axisym_wavelet_kernel(kappa_ln_translated2, R, Rplot2, P)
%title(['Wavelet translated by ',num2str(s2)])

subplot(3,1,3)
b3let_plot_axisym_wavelet_kernel(kappa_ln_translated3, R, Rplot3, P)
