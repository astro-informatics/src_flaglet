function flaglet_plot_axisym_tilling(B_l, B_n, L, N, J_min_l, J_min_n)

% flaglet_plot_axisym_tilling - Plot tilling in harmonic space.
...
[kappa kappa0] = flaglet_axisym_tilling(B_l, B_n, L, N, J_min_l, J_min_n);
