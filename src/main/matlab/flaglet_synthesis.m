function f = flaglet_synthesis(f_wav, f_scal, varargin)
...
% Default usage :
%
%   f = s2let_synthesis(f_wav, f_scal, <options>)
%
...
%  'N'               = { Azimutal band-limit; N > 1 (default=1) }
            ...
            for n = 0:N-1
                for t = 0:band_limit_l-1
                    for p = 0:2*band_limit_l-2
                        ...
                        f_wav_vec = [ f_wav_vec temp(n+1,r+1,t+1,p+1) ];
                    end
                end
            end
        end
...
f_vec = flaglet_synthesis_mex(f_wav_vec, f_scal_vec, args.B_l, args.B_p, args.L, args.P, args.J_min_l, args.J_min_p, args.tau, args.N, args.Downsample);
